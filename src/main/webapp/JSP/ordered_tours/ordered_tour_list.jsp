...
<div class="container">
    ...
    <table class="table table-striped table-hover">
        ...
        <thead>
        <tr>
            <th scope="col" class="col"><fmt:message key="label.user"/></th>
        ...
        <c:forEach var="orderedTour" items="${orderedTours}">
            <tr>
                <td>${orderedTour.user.getFullName()}</td>
                ...
                <td><a href="<%= request.getContextPath() %>/ordered_tour?ordered_tour_id=${orderedTour.id}">Edit</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
